...
const calcDislpaySummary = function (acc) {
...
dogs.forEach(
  dog => (dog.reccommendedFood = Math.trunc(dog.weight ** 0.75 * 28))
);
...
console.log(
  `Sarah's dog is eating too ${
    dogSarah.curFood > dogSarah.reccommendedFood ? 'much' : 'little'
  }`
);

const ownersEatTooMuch = dogs
  .filter(dog => dog.curFood > dog.reccommendedFood)
